...
public class OrderRecord extends UpdatableRecordImpl<OrderRecord> implements Record5<Integer, String, Date, Integer, Integer> {

    private static final long serialVersionUID = 1561173640;
     ...
     */
    @Override
    public OrderRecord values(Integer value1, String value2, Date value3, Integer value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OrderRecord(Integer id, String address, Date confirmationDate, Integer idOrderStatus, Integer idStore) {
        super(Order.ORDER);
