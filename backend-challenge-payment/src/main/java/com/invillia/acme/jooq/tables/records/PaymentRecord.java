...
public class PaymentRecord extends UpdatableRecordImpl<PaymentRecord> implements Record4<Integer, String, Timestamp, Integer> {

    private static final long serialVersionUID = 231743019;
     ...
     */
    @Override
    public PaymentRecord values(Integer value1, String value2, Timestamp value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PaymentRecord(Integer id, String creditCard, Timestamp paymentDate, Integer idPaymentStatus) {
        super(Payment.PAYMENT);
