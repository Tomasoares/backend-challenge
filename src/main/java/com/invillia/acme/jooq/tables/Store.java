...
public class Store extends TableImpl<StoreRecord> {
    ...
    private static final long serialVersionUID = -98647320;

    /**
     * The reference instance of <code>acme.store</code>
     */
    ...
    /**
     * The column <code>acme.store.id</code>.
     */
    ...
    /**
     * The column <code>acme.store.name</code>.
     */
    public final TableField<StoreRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>acme.store.code</code>.
     */
    public final TableField<StoreRecord, String> CODE = createField("code", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>acme.store.address</code>.
     */
    public final TableField<StoreRecord, String> ADDRESS = createField("address", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");

    /**
     * Create a <code>acme.store</code> table reference
     */
    public Store() {
    ...
    /**
     * Create an aliased <code>acme.store</code> table reference
     */
