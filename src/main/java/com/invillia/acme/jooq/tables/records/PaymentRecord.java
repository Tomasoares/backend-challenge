...
public class PaymentRecord extends UpdatableRecordImpl<PaymentRecord> implements Record3<Integer, String, Integer> {

    private static final long serialVersionUID = 126957825;
     ...
     */
    @Override
    public PaymentRecord values(Integer value1, String value2, Integer value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public PaymentRecord(Integer id, String creditCard, Integer idPaymentStatus) {
        super(Payment.PAYMENT);
