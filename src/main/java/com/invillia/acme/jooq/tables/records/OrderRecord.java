...
public class OrderRecord extends UpdatableRecordImpl<OrderRecord> implements Record5<Integer, String, Timestamp, Integer, Integer> {

    private static final long serialVersionUID = 1561817373;
    ...
    /**
     * Setter for <code>acme.order.confirmationDate</code>.
     */
    ...
    /**
     * Getter for <code>acme.order.confirmationDate</code>.
     */
    ...
    public Field<Timestamp> field3() {
        return Order.ORDER.CONFIRMATIONDATE;
    }
     ...
     */
    @Override
    public OrderRecord values(Integer value1, String value2, Timestamp value3, Integer value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OrderRecord(Integer id, String address, Timestamp confirmationdate, Integer idOrderStatus, Integer idStore) {
        super(Order.ORDER);

        set(0, id);
        set(1, address);
        set(2, confirmationdate);
        set(3, idOrderStatus);
        set(4, idStore);
    }
}
